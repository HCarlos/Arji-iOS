//
//  UIViewController+MasInfo_Evalua_App.m
//  Colegio Arjí A.C.
//
...
@interface MasInfo_Evalua_App ()

@end

@implementation MasInfo_Evalua_App{
    NSString *miMIME;
}

@synthesize Singleton,WebView,urlWeb,loadingView,lblPorc;
...
- (void)viewDidLoad {
    ...
    miMIME = @"text/html";
    self.urlWeb = @"https://appsto.re/mx/ZRCCbb.i";
    [self getiTunes];
    
    // NSURL *urlinSafari = [NSURL URLWithString:@"https://appsto.re/mx/ZRCCbb.i"];
